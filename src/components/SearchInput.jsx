...
function SearchInput() {
    ...
    const [isInpSearchVisible, setInpSearchVisible] = useState(false);
    ...
    return (
        <>
            {
                isWorkinOnPhone ?
                    <div className='wmia r-s-c pl10 psr'>
                        <button onClick={() => { setInpSearchVisible(true) }} className='r-s-c'>
                            <svg version="1.1" className='' viewBox="0 0 2048 2048" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <AnimatePresence >
                            ...
                            {
                                isInpSearchVisible &&
                                <div onClick={e => _OnContainerClickOut(e, form2ref.current, () => setInpSearchVisible(false))} className="backendMer" style={{ justifyContent: "start" }}>
                                    <motion.form
                                        initial={{
                                            width: "0",
                                            opacity: 0
                                        ...
                                        onSubmit={handelSubForm} ref={form2ref} className="r-s-c bg-l p5 pl10 br20 ">
                                        <div className="r-s-c " style={{ width: "100%" }}>
                                            ...
                                            <input value={term} ref={inpRef} onChange={handelFilInp} type="text" className='wmia ml10 p5 ' style={{ border: "none" }} placeholder='Search and connect with others...' />
                                        </div>
