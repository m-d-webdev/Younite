    ...
    return (
        <div onClick={handelClick} className='r-s-e p5' style={{ cursor: "pointer" }}>
            <svg version="1.1" viewBox="0 0 2000 2000" className={`${isWorkinOnPhone ? "w30 h30" :"w40 h40"} ${className} svgLogo`} xmlns="http://www.w3.org/2000/svg">
                ...
                <path transform="translate(898,1145)" d="m0 0 4 2 8 12 8 13 13 23 7 17 5 15 3 13 2 18v30l-4 18-4 15-6 18-7 15-8 14-7 11-7 10h-2l-2 4-10 11-5 5-13 12-10 7-21 13-9 4-10 6-8 4h-4v2l-16 3-1 1h-16l-16-2v-1l17-3 13-3 19-5 16-5 16-8 21-14 5-4h2v-2l11-9 9-9 7-8 6-7 13-20 10-19 6-17 5-18 3-18v-32l-2-19-6-22-7-20-12-22-9-14-5-8-1-3-3-2h2z" fill="#049EDE" />
                <path transform="translate(1438,900)" d="m0 0h6l2 4-11 18-12 19-14 23-9 14-4 4-4-2v-2h-2l2-8 6-12 2-3h2l2-5 4-8 6-9 10-17 6-8h2v-2h2v-2h2z" fill="#049EDE" />
                <path transform="translate(1473,847)" d="m0 0 6 2-2 5-12 20-8 13h-2l-1-4-4-1 2-5 1-2h2l1-5 8-11 4-2 1-5 2-4z" fill="#049EDF" />
                <path transform="translate(1145,1339)" d="m0 0h3l-1 4-8 7-3-1-1-3 3-5z" fill="#049FDF" />
                <path transform="translate(703,600)" d="m0 0 4 1-2 1-2 4-6 5-3 3h-3l2-4z" fill="#04A1E3" />
