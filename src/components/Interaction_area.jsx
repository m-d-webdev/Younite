    ...
    return (
        <div className={className}>

            {
                PostLiked ?
                    <span onClick={Des_like} className={svg_className} >
                        <svg className={`${isWorkinOnPhone ? "w-2 h-2 " :""} likeActive animate__animated`} version="1.1" style={{ cursor: "pointer" }} viewBox="0 0 2048 2048"  xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span onClick={Send_like} className={svg_className}>
                        <svg className={`${isWorkinOnPhone ? "w-2 h-2" :""}`} version="1.1" style={{ cursor: "pointer" }} viewBox="0 0 2048 2048" xmlns="http://www.w3.org/2000/svg">
            ...
            <span onClick={handelOpenComments}
                ...
                <svg className={`${isWorkinOnPhone ? "w-2 h-2" :""}`} version="1.1" viewBox="0 0 2048 2048"  xmlns="http://www.w3.org/2000/svg">
