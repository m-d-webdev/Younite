        ...
        <div className='wmia'>
            ...
            </>
            {
                ...
                <>
                    ...
                    <div className="list_newMoments c-s-c bg-l scrl_none wmia pl5 pt15" style={{ minHeight: "100px", maxHeight: "330px", overflow: "auto" }}>
                        {
                            isLoading ?
                                ...
                                (
                                    Moments.length > 0 ?
                                        ...
                                        :
                                        <p className='opacity-60'>No moment yet  </p>
                                )
                        }
                    </div>
                </>
